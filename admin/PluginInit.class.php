...
class PluginInit
{
    ...
    private function load_textdomain(): void
    {
        ...
        load_textdomain('wpms', UtilEnv::normalize_path(WPMS_ABSPATH . 'languages/') . $mo_file);
    }

    private function maybe_upgrade(): void
    {
        $version = wps('wpms')->settings->get('ver', false);

        // need upgrade
        if (!$version or version_compare($version, WPMS_VERSION, '<')) {
