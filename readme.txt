...
URI: https://github.com/sh1zen/wp-memberhip/blob/master/LICENSE

The membership plugin for developers

== Description ==

Improve Your WordPress Performance and SEO with WP-Optimizer (WPMS) - Contains the most requested features for maintaining WordPress. Customizable in few easy steps to increase your website performances for an enhanced and safer user experience.
...
beer or coffee [here](https://www.paypal.com/donate/?business=dev.sh1zen%40outlook.it&item_name=Thank+you+in+advanced+for+the+kind+donations.+You+will+sustain+me+developing+WP-Optimizer.&currency_code=EUR), I will really appreciate it.
